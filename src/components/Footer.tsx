      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-300">
              The all-in-one CRM and marketing automation platform built specifically for trade businesses.
              Grow your roofing, HVAC, plumbing, or contracting business with powerful tools.
            </p>
          ...
          <div className="md:flex md:items-center md:justify-between">
            <div className="max-w-xl">
              ...
              <p className="mt-2 text-sm leading-6 text-gray-300">
                Get the latest tips, industry insights, and product updates delivered to your inbox.
              </p>
            </div>
            <form className="mt-6 sm:flex sm:max-w-md md:mt-0">
              ...
              <input
                ...
                autoComplete="email"
                required
                className="w-full min-w-0 appearance-none rounded-md border-0 bg-white/5 px-3 py-1.5 text-base text-white shadow-sm ring-1 ring-inset ring-white/10 placeholder:text-gray-500 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:w-64 sm:text-sm sm:leading-6"
        ...
        <div className="mt-8 border-t border-gray-700 pt-8">
          <p className="text-xs leading-5 text-gray-400">
            &copy; {new Date().getFullYear()} TradeFlow. All rights reserved. Built for trades, by people who understand your business.
          </p>
        </div>
      </div>
    </footer>
